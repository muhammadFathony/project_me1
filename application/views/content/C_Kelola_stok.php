             ...
             <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="form-group id="t">
                    <input type="hidden" name="" value="<?php echo $kd_barang ?> ">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-group has-feedback">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control reset hapus" id="kd_barang" placeholder="Kode Barang" name="kd_barang" readonly="" value="<?= $kd_barang ?>">
                        <span class="fa fa-cubes form-control-feedback right" aria-hidden="true"></span>
                      </div>
                      </div>
...
<script type="text/javascript">
        ...
        $('#tanggal').datetimepicker({
              ...
              "serverSide": false,
                ...
                var id_tmasuk = $(this).val();
								...
								if (event.keyCode == 13) {
									 $.ajax({
                    type : "POST",
                    url : "<?php echo base_url('Kelola_Stok/add_tabel') ?>",
                    dataType : "JSON",
                    data : { 
                          id_tag: id_tag,
                          kd_barang : kd_barang,
         ...
         $('#btn_delete').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('Kelola_Stok/delete_list_tranksaksi')?>",
                dataType : "JSON",
                data : {id_tag:id_tag},
                success: function(data){
                  emit_Tag();
         ...
         swal({
            ...
            function() {
              ...
              $.ajax({
                data : data,
                type : 'POST',
                url : '<?php echo base_url('Kelola_Stok/save_count') ?>',
                crossOrigin : false,
                dataType : 'JSON',
