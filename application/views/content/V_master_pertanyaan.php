    ...
    <div class="">
      <div class="page-title">
        ...
        <!-- endmodals -->
                ...
                <!-- tabel data -->
                 <div class="x_content">
                  <p>Master Data Pertanyaan <code>Sistem Pembelajaran Warna</code></p> 
                    <table class="table table-striped table-bordered" id="tbpertanyaan">
                      <thead>
                        <tr class="">
                          <th class="">No </th>
                          <th class="">Pertanyaan </th>
                          <th class="">Kategori Soal </th>
...
$(document).ready(function(){
    ...
    var tabel = $('#tbpertanyaan').dataTable({
        ...
        "sAjaxSource": 	'<?php echo base_url(); ?>index.php/penilaian/get_pertanyaan',
