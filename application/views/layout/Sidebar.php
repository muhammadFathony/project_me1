          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="<?php echo base_url();?>assets/img/newrealJansen.png" alt="..." class="img-circle profile_img">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <?php if ($this->session->userdata('level')=='admin' || $this->session->userdata('level')=='user' || $this->session->userdata('level')=='administrator') {?>
                    <li><a><i class="fa fa-cubes"></i> Kelola Barang <span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                        <li><a href="<?php echo base_url('Data_Barang.html');?>">Lihat Daftar Barang</a></li>
                        <?php if ($this->session->userdata('level')=='admin' || $this->session->userdata('level')=='administrator') {  
                        ?>
                        <li><a href="<?php echo base_url('Data_Barang/Barang');?>">Tambah Data Barang</a></li>
                        <?php }?>
                      </ul>
                    </li>
                  <?php } ?>
                  ...
                  <li><a><i class="fa fa-desktop"></i> Kelola Stok <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url('Kelola_Stok/view_ledger.html') ?>">Lihat Transaksi Masuk</a></li>
                      <?php if ($this->session->userdata('level')=='admin'|| $this->session->userdata('level')=='administrator') {
                      ?>
                  ...
                  <?php if ($this->session->userdata('level')=='admin' || $this->session->userdata('level')=='pimpinan' || $this->session->userdata('level')=='administrator') {?>
